...
with tf.Session() as sess:
	cnn = CNN.shallow([28, 28, 1], 10, sess=sess, name='ParallellCNN')
	...
	rnn = NeuralNet.recurrent([28], 28, 128, 10, name='ParallellRNN', sess=sess)
...
with tf.Session() as sess:
	cnn = CNN.shallow([28, 28, 1], 10, name='ParallellCNN', sess=sess)
